            ...
            <datapoints>
                <xsl:for-each
                    ...
                    <xsl:variable name="graddress"
                                  select="/b:KNX/b:Project/b:Installations/b:Installation/b:GroupAddresses/b:GroupRanges/b:GroupRange//*"/>
                    <xsl:variable name="GroupAddressRefId" select="./b:Connectors[0]" />
                    <datapoint>
                        <xsl:attribute name="stateBased">
                            <xsl:value-of select="'true'"/>
                        </xsl:attribute>
<!--                        <xsl:attribute name="name">-->
<!--&lt;!&ndash;                            <xsl:value-of select="$verz/@Name"/>&ndash;&gt;-->
...
<!--                        </xsl:attribute>-->
                        ...
                        <xsl:for-each select="b:Send">
                            <xsl:attribute name="name">
                                <xsl:value-of select="$graddress[@Id = current()/@GroupAddressRefId]/@Name"/>
                            </xsl:attribute>
